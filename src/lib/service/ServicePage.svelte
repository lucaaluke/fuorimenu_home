<script lang="ts">
  ...
  onMount(() => {
    ...
    if (sessionStorage.getItem('role-card-transition') !== '1') return;
...
<main class="service-page">
  <header class="service-topbar" aria-label="Navigazione servizio">
    <a
      class="logo"
      href="/?view=brand"
...
<style>
  ...
  .service-topbar .logo::before,
  .service-topbar .icon-button::before,
  .service-topbar .home-link::before {
    position: absolute;
    z-index: 0;
    inset: 0;
  ...
  .service-topbar .logo::after,
  .service-topbar .icon-button::after,
  .service-topbar .home-link::after {
    position: absolute;
    z-index: 1;
    inset: 0;
    border: 2px solid var(--topbar-control-fg);
  ...
  .service-topbar .logo:hover,
  .service-topbar .logo:focus-visible,
  .service-topbar .icon-button:hover,
  .service-topbar .icon-button:focus-visible,
  ...
  .service-topbar .logo:hover::after,
  .service-topbar .logo:focus-visible::after,
  .service-topbar .icon-button:hover::after,
  .service-topbar .icon-button:focus-visible::after,
  .service-topbar .home-link:hover::after,
  .service-topbar .home-link:focus-visible::after {
    border-color: var(--topbar-control-fg);
    background: var(--topbar-control-hover-bg);
  }

  .service-topbar .logo:hover::before,
  .service-topbar .logo:focus-visible::before,
  .service-topbar .icon-button:hover::before,
  .service-topbar .icon-button:focus-visible::before,
  .service-topbar .home-link:hover::before,
  .service-topbar .home-link:focus-visible::before {
    opacity: 1;
  }

  .service-topbar .logo:active,
  .service-topbar .icon-button:active,
  .service-topbar .home-link:active {
    --button-lift-x: 0px;
    --button-lift-y: -1px;
    --button-hover-scale: 1;
  }

  .service-topbar .logo:active::before,
  .service-topbar .icon-button:active::before,
  .service-topbar .home-link:active::before {
    opacity: 1;
  }
