...
export const kitchenAssets: SceneAsset[] = [
  ...
  ...kitchenInteractiveMiddleAssets,
  {
    ...
    id: 'tool-shed',
    kind: 'interactive',
    src: 'kitchen/interactive/tool-shed.svg',
    x: 5500,
    y: 595 - 180.446,
    width: 166.747,
    height: 180.446,
  ...
  },
  {
    id: 'stand-mixer',
    kind: 'interactive',
    src: 'kitchen/interactive/stand-mixer.svg',
    nodeId: '3622:4038',
    x: 6690,
    y: 545 - 160,
    width: 154,
  ...
  },
  {
    id: 'layer-fg',
    kind: 'static',
    src: 'kitchen/legacy-layers/layer-fg.svg',
    x: 0,
    y: 0,
    width: kitchenSceneConfig.assetWidth,
  ...
  },
  {
    id: 'layer-fg-tail',
    kind: 'static',
    src: 'kitchen/legacy-layers/layer-fg-tail.svg',
    x: 0,
    y: kitchenTailY,
    width: 23000,
    height: kitchenTailHeight,
